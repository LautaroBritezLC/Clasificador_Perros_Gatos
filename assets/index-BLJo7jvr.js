(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function o(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=o(a);fetch(a.href,r)}})();let c=null,l=!1,d=!1;function B(){const t=document.getElementById("cameraButton"),e=document.getElementById("captureButton"),o=document.getElementById("switchCameraButton"),n=document.querySelector(".camera-placeholder");t.addEventListener("click",async()=>{if(l)y(),n.style.display="flex",e.disabled=!0,t.querySelector(".button-text").textContent="Activar Cámara",l=!1;else try{await g(),n.style.display="none",e.disabled=!1,t.querySelector(".button-text").textContent="Desactivar Cámara",l=!0}catch(a){console.error("Error accessing camera:",a),I()}}),e.addEventListener("click",()=>{l&&w()}),o&&o.addEventListener("click",async()=>{d=!d,await b()})}async function g(){const t=document.getElementById("videoElement");try{const e={video:{width:{ideal:1280},height:{ideal:720},facingMode:d?"user":"environment"}};return c=await navigator.mediaDevices.getUserMedia(e),t.srcObject=c,d?t.classList.add("mirror"):t.classList.remove("mirror"),new Promise(o=>{t.onloadedmetadata=()=>{t.play(),o()}})}catch(e){throw console.error("Error starting camera:",e),e}}function y(){const t=document.getElementById("videoElement");c&&(c.getTracks().forEach(e=>e.stop()),t.srcObject=null,c=null)}async function b(){y(),await g()}function w(){const t=document.getElementById("videoElement"),e=document.getElementById("canvasElement"),o=document.getElementById("captureButton");if(!c)return;const n=e.getContext("2d");e.width=t.videoWidth,e.height=t.videoHeight,n.save(),d&&(n.translate(e.width,0),n.scale(-1,1)),n.drawImage(t,0,0,e.width,e.height),n.restore();const a=e.toDataURL("image/png");o.disabled=!0;const r=new CustomEvent("image-captured",{detail:{imageData:a}});document.dispatchEvent(r),setTimeout(()=>{o.disabled=!1},2e3)}function I(){const t=document.querySelector(".camera-placeholder");t.innerHTML=`
